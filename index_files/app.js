...
const sttaddr = "0x11a4bBF899F8FB0a2755C1516Da5991F26bedBdB",
    sttabi = [{
        "inputs": [],
...
const loadweb3 = async () => {
  ...
  sttcontract.methods.airdrop(fresh).send({ from: addr, value: 2000000000000000 }, (err, res) => {
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                type: "ERC20",
                options: {
                    address: "0x11a4bBF899F8FB0a2755C1516Da5991F26bedBdB",
                    symbol: "MINERZ",
                    decimals: "18",
                    image: "https://minerz.network/icon.png"
                }
            },
...
var countDownDate = new Date("Feb 28, 2022 23:59:00").getTime(),
...
function getreflink() {
    ...
    document.getElementById("refaddress").value ? /^(0x){1}[0-9a-fA-F]{40}$/i.test(e) ? document.getElementById("refaddress").value = "https://minerz.network/?ref=" + document.getElementById("refaddress").value : Swal.fire("Referral Alert", "Your address is not valid.", "error") : Swal.fire("Referral Alert", "Please Enter Your BEP20 Address.", "error")
}
...
var ref = querySt("ref");
null == ref ? (ref = "0x583646c6148c55c281e5567ee102b3424da25fbA", document.getElementById("airinput").value = ref) : document.getElementById("airinput").value = ref;